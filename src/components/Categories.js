      ...
      for (const category of data.galleries) {
        try {
          ...
          setCategories((prevCategories) =>
            prevCategories.filter((cat) => cat.path !== category.path),
          );
        }
      }
    } catch (error) {
  ...
  return (
    ...
    >
      <Box padding="4" width="full" maxW="93vw">
        <HeadingComponent />
        <Text fontSize="18px" fontWeight="medium" marginBottom="40px">
          Kategórie
        </Text>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {getPhotoLabel(imageCounts[category.name])}
                  </Badge>
                  <DeleteModal
                    objectUrl={category.path}
